...
const Impact = () => {
  ...
  // Words specific to the Impact page
  const words = ["Impact", "Reach", "Legacy", "Results"];
        ...
        <section className="page-header">
          <div className="container">
            ...
            <h1 className="page-header-title">
              Our <span style={{ color: '#ffab17' }}>{text}</span><span className="cursor">|</span>
            </h1>
          </div>
        </section>
        ...
        <section className="why-donate">
          <div className="container">
            <div className="why-donate-content">
              <div>
                <h2 className="section-title" style={{ textAlign: 'left' }}>Why Donate with Us</h2>
                <div className="features-list">
                  <div className="feature-icon">✓</div>
                  <div className="feature-text">Verified Causes</div>
                  <div className="feature-icon">🔒</div>
                  <div className="feature-text">Secured Payments</div>
                  <div className="feature-icon">📊</div>
                  <div className="feature-text">Track Your Impact</div>
                </div>
              </div>
              <div>
                <div className="stats-grid">
                  <div className="stat-item">
                    <div className="stat-number">₹40Cr+</div>
                    <div className="stat-label">Raised</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-number">25+</div>
                    <div className="stat-label">NGOs on Board</div>
                  </div>
                  <div className="stat-item">
                ...
                <div className="testimonial">
                  <img src="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='50' r='45' fill='%23f0f0f0'/><circle cx='50' cy='40' r='15' fill='%23666'/><path d='M35 65c0-8 7-15 15-15s15 7 15 15z' fill='%23666'/></svg>" alt="Anita Sharma" className="testimonial-image" />
                  <div className="testimonial-content">
                    <p className="testimonial-text">"Thanks to you my daughter can go to school now"</p>
                    <div className="testimonial-author">Anita Sharma</div>
                  </div>
                </div>
              </div>
            </div>
